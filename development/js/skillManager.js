...
Laro.register('PD', function (La) {
	 ...
	 */
	this.Sill_active = La.BaseState.extend(function () {
	 ...
	 * @return {[type]} [description]
	 */
	this.Sill_await = La.BaseState.extend(function () {
	 ...
	 * @return {[type]} [description]
	 */
	this.Sill_reload = La.BaseState.extend(function () {
	 ...
	 * @return {[type]}        [description]
	 */
	this.Skill = La.Class(function (cfg) {
